...
```bash
docker build -t localhost:5000/azureml/amlarc/docker/relayserver:1.1.91 https://github.com/szasza576/arc-on-arm.git#main:azureml/relayserver
docker push localhost:5000/azureml/amlarc/docker/relayserver:1.1.91
```
